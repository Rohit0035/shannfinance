...
<main>
                ...
                <div class="col-12">
                    <div class="breadcrumb__content">
                        <div class="breadcrumb__title-wrapper mb-15 mb-sm-10 mb-xs-5">
                            <h2 class="breadcrumb__title mb-0 wow fadeIn animated" data-wow-delay=".1s">About Us</h2>
                        </div>
                ...
                <!-- <div class="col-md-12 wow fadeIn animated" data-wow-delay=".5s">
                    <div class="shadow mb-4 p-4 st-bx-1">
                        ...
                        <ul class="" style="list-style:none;">
                            <li>1. We shall adhere, individually and collectively, to our commitments, our values, and the ethical conduct of our business.<li>
                            <li>2. We shall endeavor to provide products and services up to the utmost satisfaction of our customers.</li>
                          
                            <li>3. To constantly endeavor to attain excellence.</li>
                            <li>4. We shall constantly and continuously strive for financial literacy through conducting various awareness programmes in our area of operation.</li>
                           
                            <li>5. We shall ensure better delivery of our products as per the desire of the customers.</li>
                            <li>6. We shall be more transparent, trustworthy and work with a philosophy of togetherness while conducting business,</li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="swiper brand__active">
                        <div class="swiper-wrapper wow fadeIn animated" data-wow-delay=".3s">
            ...
            <div class="row">
                <!-- <div class="col-md-3 mb-3">
                    <div class="our-team__item d-flex align-items-center flex-column">
                        ...
                        <div class="our-team__item-content text-center">
                            <a href="index.php">
                                <h4 class="title text-capitalize mb-10">Jyothi</h4>
                            </a>
                            <span class="mb-20 d-block"> Director</span>
                            <p>
                ...
                <div class="col-md-3 mb-3">
                    <div class="our-team__item d-flex align-items-center flex-column">
                        ...
                        <div class="our-team__item-content text-center">
                            <a href="index.php">
                                <h4 class="title text-capitalize mb-10">Mahaveer Solanki</h4>
                            </a>
                            <span class="mb-20 d-block"> Director</span>
                            <p>
                                Mahaveer Solanki, is a committed and result oriented person
                ...
                <div class="col-md-3 mb-3">
                    <div class="our-team__item d-flex align-items-center flex-column">
                        ...
                        <div class="our-team__item-content text-center">
                            <a href="index.php">
                                <h4 class="title text-capitalize mb-10">Mr.Birendra Kumar</h4>
                            </a>
                ...
                <div class="col-md-3 mb-3">
                    <div class="our-team__item d-flex align-items-center flex-column">
                        ...
                        <div class="our-team__item-content text-center">
                            <a href="index.php">
                                <h4 class="title text-capitalize mb-10">Mr. Tara Prasad Misra</h4>
                            </a>
    ...
    <!-- <section class="work-process__area section-space-bottom">
        <div class="container">
            <div class="row align-items-end">
                <div class="col-xl-5">
                    <div class="section__title-wrapper">
                        <span class="section__subtitle uppercase mb-20 wow fadeIn animated" data-wow-delay=".1s" >WORK PROCESS <img class="leftRight" src="assets/imgs/icons/arrow-right-circle.svg" alt="arrow not found"></span>
                        <h2 class="section__title wow fadeIn animated mb-0" data-wow-delay=".3s">Strategies for Tomorrow's Success</h2>
                    </div>
                </div>
                <div class="col-xl-7">
                    <div class="work-process__description wow fadeIn animated" data-wow-delay=".4s">
            ...
            <div class="row">
                <div class="work-process__item-wrapper mt-60 mt-sm-50 mt-xs-40 d-flex flex-column">
                    <div class="work-process__item d-flex align-items-center wow fadeIn animated" data-wow-delay=".3s">
                        <div class="work-process__item-header d-flex align-items-center wow fadeIn animated" data-wow-delay=".6s">
                            <div class="work-process__item-icon">
                                <img src="assets/imgs/about/work-progress__item-1.png" class="img-fluid" alt="image not found">
                            </div>
                    ...
                    <div class="work-process__item active d-flex align-items-center">
                        <div class="work-process__item-header d-flex align-items-center">
                            <div class="work-process__item-icon">
                                <img src="assets/imgs/about/work-progress__item-2.png" class="img-fluid" alt="image not found">
                            </div>
                    ...
                    <div class="work-process__item d-flex align-items-center wow fadeIn animated" data-wow-delay=".9s">
                        <div class="work-process__item-header d-flex align-items-center">
                            <div class="work-process__item-icon">
                                <img src="assets/imgs/about/work-progress__item-3.png" class="img-fluid" alt="image not found">
                            </div>
    ...
    <!-- <section class="work-progress section-space-bottom">
        <div class="container-fluid">
            <div class="row mb-minus-30">
                <div class="col-xl-3 col-md-6 wow fadeIn animated" data-wow-delay=".3s">
                    <div class="work-progress__item d-flex align-items-center justify-content-center mb-30" data-bg-color="#004aac">
                        <div class="work-progress__item-icon">
                            <img src="assets/imgs/home1/work-progress-1.png" alt="image not found">
                        </div>
                        <div class="work-progress__item-text">
                            <h2 class="title color-white"><span class="counter">200</span>+</h2>
                            <p class="color-white">Team member</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 wow fadeIn animated" data-wow-delay=".5s">
                    <div class="work-progress__item d-flex align-items-center justify-content-center mb-30" data-bg-color="#004aac">
                        <div class="work-progress__item-icon">
                            <img src="assets/imgs/home1/work-progress-2.png" alt="image not found">
                        </div>
                        <div class="work-progress__item-text">
                            <h2 class="title color-white"><span class="counter">10</span>k+</h2>
                            <p class="color-white">Complete project</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 wow fadeIn animated" data-wow-delay=".7s">
                    <div class="work-progress__item d-flex align-items-center justify-content-center mb-30" data-bg-color="#004aac">
                        <div class="work-progress__item-icon">
                            <img src="assets/imgs/home1/work-progress-3.png" alt="image not found">
                        </div>
                        <div class="work-progress__item-text">
                            <h2 class="title color-white"><span class="counter">200</span>+</h2>
                            <p class="color-white">Winning award</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 wow fadeIn animated" data-wow-delay=".9s">
                    <div class="work-progress__item d-flex align-items-center justify-content-center mb-30" data-bg-color="#004aac">
                        <div class="work-progress__item-icon">
                            <img src="assets/imgs/home1/work-progress-4.png" alt="image not found">
                        </div>
                        <div class="work-progress__item-text">
                            <h2 class="title color-white"><span class="counter">900</span>+</h2>
                            <p class="color-white">Client review</p>
                        </div>
                    </div>
                </div>
            </div>
